/**
 * @file openxum/core/games/kikotsoka-polyomino/coordinates.hpp
...
#ifndef OPENXUM_CORE_GAMES_KIKOTSOKA_POLYOMINO_COORDINATES_HPP
#define OPENXUM_CORE_GAMES_KIKOTSOKA_POLYOMINO_COORDINATES_HPP
